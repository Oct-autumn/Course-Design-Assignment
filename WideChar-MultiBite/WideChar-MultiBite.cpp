// WideChar-MultiBite.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
    ...
    //wprintf(L"%wc", WideSTR);

    char MultiSTR[25] = { 0 };

    WCtoMB(WideSTR, MultiSTR, sizeof(MultiSTR) / sizeof(MultiSTR[0]));
